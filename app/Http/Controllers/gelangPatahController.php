...
class gelangPatahController extends Controller
{

    public function toSell(){
        $view=Property::all()->where('publishFunction', value("Sell")); 
        return view('gelangPatah')->with('properties', $view);
    }

    public function district(){
        $view=Property::all()->where('district', value("Gelang Patah")); 
        return view('gelangPatah')->with('properties', $view);
}
...
public function addToFavourite(){
    ...
    return redirect()->route('gelangPatah')->with('properties', $Favourite);
}
