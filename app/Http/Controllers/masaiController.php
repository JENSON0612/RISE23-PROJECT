...
class masaiController extends Controller
{

    public function toSell(){
        $view=Property::all()->where('publishFunction', value("Sell")); 
        return view('masai')->with('properties', $view);
    }

    public function district(){
        $view=Property::all()->where('district', value("Masai")); 
        return view('masai')->with('properties', $view);
}
...
public function addToFavourite(){
    ...
    return redirect()->route('masai')->with('properties', $Favourite);
}
