...
<form action="{{route('apartment')}}" method="post" enctype="multipart/form-data" style="display: inline" class="" id="addFavourite">     @csrf
<div class="propertiesContentContainer">
    <div class="propertiesInContent">
        ...
        <input type="hidden" name="propertyPic" value="{{asset('images')}}/{{$property->propertyPic}}"  multiple>
            ...
            <a href="{{route('ratingAppointment')}}"><div onclick="propertyBtn()" class="bookAppointment">Request Appointment</div></a>
        </article>
        ...
        <article class="propertyDescription" id="propertyDescription">
            ...
            <button class="bookNow"function="addToFavourite" type="submit"></button></h5>z
