...
class tanjungPelepasController extends Controller
{

    public function toSell(){
        $view=Property::all()->where('publishFunction', value("Sell")); 
        return view('tanjungPelepas')->with('properties', $view);
    }

    public function district(){
        $view=Property::all()->where('district', value("Tanjung Pelepas")); 
        return view('tanjungPelepas')->with('properties', $view);
}
...
public function addToFavourite(){
    ...
    return redirect()->route('tanjungPelepas')->with('properties', $Favourite);
}
