...
class tanjungKupangController extends Controller
{

    public function toSell(){
        $view=Property::all()->where('publishFunction', value("Sell")); 
        return view('tanjungKupang')->with('properties', $view);
    }

    public function district(){
        $view=Property::all()->where('district', value("Tanjung Kupang")); 
        return view('tanjungKupang')->with('properties', $view);
}
...
public function addToFavourite(){
    ...
    return redirect()->route('tanjungKupang')->with('properties', $Favourite);
}
