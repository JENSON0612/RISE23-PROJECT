...
class kotaIskandarController extends Controller
{

    public function toSell(){
        $view=Property::all()->where('publishFunction', value("Sell")); 
        return view('kotaIskandar')->with('properties', $view);
    }

    public function district(){
        $view=Property::all()->where('district', value("Kota Iskandar")); 
        return view('kotaIskandar')->with('properties', $view);
}
...
public function addToFavourite(){
    ...
    return redirect()->route('kotaIskandar')->with('properties', $Favourite);
}
